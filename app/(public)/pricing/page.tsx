...
const PLANS: Plan[] = [
  {
    ...
    limitations: [
      "No Call/WhatsApp contact buttons",
      "No private postings",
      "No analytics",
    ],
  },
...
const COMPARISON_ROWS = [
  ...
  { feature: "Talent page access", free: `${FREE_PLAN_TALENT_LIMIT} profiles`, standard: `${FREE_PLAN_TALENT_LIMIT} profiles`, monthly: "Unlimited", term: "Unlimited" },
  { feature: "Call / WhatsApp applicants", free: false, standard: false, monthly: true, term: true },
