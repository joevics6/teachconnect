...
// Nigerian states/LGAs data, kept as a plain module (no "use client")
// so it can be imported from server code (API routes) as well as
// client components. This was previously only defined inside
// components/ui/StateLgaSelect.tsx, which is a "use client" file —
// importing a "use client" file's exports from a server route
// doesn't reliably give you the real value (that's what caused
// "NIGERIAN_STATES.join is not a function" in
// app/api/admin/jobs/parse/route.ts). StateLgaSelect.tsx now
...
export const NIGERIAN_LGAS: Record<string, string[]> = {
  ...
  "Bauchi": ["Alkaleri","Bauchi","Bogoro","Damban","Darazo","Dass","Gamawa","Ganjuwa","Giade","Itas/Gadau","Katagum","Kirfi","Misau","Ningi","Shira","Tafawa Balewa","Toro","Warji","Zaki"],
  ...
  "Katsina": ["Bakori","Batagarawa","Batsari","Baure","Bindawa","Charanchi","Dandume","Danja","Dan Musa","Daura","Dutsi","Dutsin Ma","Faskari","Funtua","Ingawa","Jibia","Kafur","Kaita","Kankara","Kankia","Katsina","Kurfi","Kusada","Malumfashi","Mani","Mashi","Matazu","Musawa","Rimi","Sabuwa","Safana","Sandamu","Zango"],
  ...
  "Plateau": ["Barkin Ladi","Bassa","Bokkos","Jos East","Jos North","Jos South","Kanam","Kanke","Langtang North","Langtang South","Mangu","Mikang","Pankshin","Riyom","Shendam","Wase"],
...
export const NIGERIAN_STATES = Object.keys(NIGERIAN_LGAS).sort()
